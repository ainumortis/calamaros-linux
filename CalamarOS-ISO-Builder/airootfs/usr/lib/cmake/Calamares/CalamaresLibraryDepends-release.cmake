...
set_target_properties(calamares PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcalamares.so.2.4.5"
  IMPORTED_SONAME_RELEASE "libcalamares.so.2.4.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS calamares )
list(APPEND _IMPORT_CHECK_FILES_FOR_calamares "${_IMPORT_PREFIX}/lib/libcalamares.so.2.4.5" )
...
set_target_properties(calamaresui PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcalamaresui.so.2.4.5"
  IMPORTED_SONAME_RELEASE "libcalamaresui.so.2.4.5"
  )

list(APPEND _IMPORT_CHECK_TARGETS calamaresui )
list(APPEND _IMPORT_CHECK_FILES_FOR_calamaresui "${_IMPORT_PREFIX}/lib/libcalamaresui.so.2.4.5" )
